...
class LastRenewalNotice extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ...
                    ->line('Hi '. $notifiable->name .' Your Legalpedia package '. $this->package->name .' expires in 24hrs. Renew you subscription now to retain access to Legalpedia resources.')
