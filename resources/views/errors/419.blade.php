        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-6 align-self-center m-100">
              <h1 class="text-green">419</h1>
              <h2>Session Expired.</h2>
              <p class="pb-3">Your current session has expired, please sign in again to start a new session
              </p>
              <a href="{{route('login')}}" class="custom-btn-green"><i class="mdi mdi-arrow-left"></i> Sign in</a>
            </div>
          </div>
        </div>
    </main>
