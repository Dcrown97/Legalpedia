...
<head>
    ...
    <link rel="stylesheet/less" type="text/css" href="{{asset('assets/css/css/404.scss')}}">
    <script type="text/babel" src="{{asset('assets/js/js/babel.js')}}"></script>
...
<body>
    <style>
        ...
        .custom-btn-green{
            ...
            border: 1px solid #EC6959 !important;
            border-radius: 5px;
            color: #fff !important;
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6 align-self-center">
              <svg class="custom-h" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                viewBox="0 0 800 600">
                <g>
                  <defs>
            ...
            <div class="col-md-6 align-self-center m-100">
              <h1 class="text-green">500</h1>
              <h2>Seems there's a server error.</h2>
              <p class="pb-3">If you're on this page it means you're experiencing a server error. Please contact your admin support to rectify this issue
              </p>
              <a href="{{url('admin/dashboard')}}" class="custom-btn-green"><i class="mdi mdi-arrow-left"></i> Return to dashboard</a>
            </div>
          </div>
        </div>
    </main>
