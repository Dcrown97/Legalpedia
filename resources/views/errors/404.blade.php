        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-6 align-self-center m-100">
              ...
              <h2>UH OH! Seems you're lost.</h2>
              <p class="pb-3">The page you are looking for does not exist. click the button below
                to go back to your dashboard.
              </p>
              <a href="{{url('admin/dashboard')}}" class="custom-btn-green"><i class="mdi mdi-arrow-left"></i> Back to dashboard</a>
            </div>
          </div>
        </div>
    </main>
