                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 text-right">
                            @if($new_price)
                                <h5 style="color: #004053; font-weight: 600">₦{{number_format($new_price, 2)}}</h5>
                                <small class="text-muted mt-2">
                                    @php
                                        $discounted_price = $package->price - $new_price;
                                    @endphp
                                    Discount: <span class="text-color">- ₦{{number_format($discounted_price, 2)}}</span>
                                </small>
                                @else
                    ...
                    <form id="paymentForm">
                        ...
                        @if($new_price)
                            <input type="hidden" name="amount" value="{{$new_price * 100}}">
                            @else
                    ...
                    <form action="{{route('payment.success', $random_string)}}" method="POST" id="bankPayment">
                        ...
                        @php
                            $discounted_price = $package->price - $new_price;
                        @endphp
                        <input type="hidden" name="discounted_price" value="{{$discounted_price ? $discounted_price : ''}}">
                        <input type="hidden" name="recur_date" value="{{$package->recur_date}}">
