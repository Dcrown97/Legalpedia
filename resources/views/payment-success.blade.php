...
@section('content-1')
    <div class="text-center container">
        <div class="container">
            ...
            <p><a href="{{ url('admin/dashboard') }}" class="text-color" style="text-decoration: none"><i
                        class="mdi mdi-arrow-left"></i> Back to dashboard </a></p>
        </div>
    </div>
@endsection
...
@section('content-2')
    ...
    <div class="text-center">
        ...
        <div class="row text-center justify-content-center p-4">
            <p class="text-color">Account Number: 1903991150 <br>
                Account Name: LEGALPEDIA AI AND TECH SERVICES LTD<br>
                Bank: Access bank <br>
            </p>
        </div>
    </div>
