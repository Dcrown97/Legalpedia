...
@section('content')
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        @if(Auth::user()->role->name == 'Admin')
                            <span class="mr-4"><a href="#" data-bs-target="#rate" data-bs-toggle="modal"><i class="mdi mdi-star"></i> <i class="mdi mdi-star"></i> Rate this Article</a></span>
                    ...
                    <div class="card-header border-0">
                        <div class="row">
                            <div class="col">
                                ...
                                <br>
                                @php
                                    $like_count = App\Models\Like::where('article_id', $article->id)->where('like', 1)->count();
                                @endphp
                                <span id="like-div">
                            ...
                            <div class="col-auto">
                                <form id="like-form" class="mr-4">
                                    ...
                                    @php
                                        $likes = App\Models\Like::where('article_id', $article->id)->get();
                                        $user_has_liked = App\Models\Like::where('article_id', $article->id)->where('user_id', Auth::user()->id)->where('like', 1)->first();
                                        $user_has_unliked = App\Models\Like::where('article_id', $article->id)->where('user_id', Auth::user()->id)->where('like', 0)->first();
                                        $user_has_not_liked = App\Models\Like::where('article_id', $article->id)->first();
                                    @endphp
                                    @if(count($likes) > 0)
                                        @if($user_has_liked)
                    ...
                    <div class="px-5 border-top-xs">
                        <div class="row">
                            <div class="col-12">
                                <form action="{{route('rate.article', $article->id)}}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="reference_id" value="{{$article->id}}">
    ...
    <script>
        ...
        function like() {
            ...
            $.ajax({
                type:'POST',
                url: "{{ url('/admin/legal-articles/like')}}",
                data:{
                    "_token": "{{ csrf_token() }}",
                    user_id:user_id,
    ...
    <script>
        ...
        function fetchAnote() {
            $.ajax({
                type: 'GET',
                url: "/admin/legal-articles/fetch-annotations/" + articleId,
                success: function (response) {
                    console.log(response);
