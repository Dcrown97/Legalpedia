        ...
        <div class="container-fluid">
            <div class="header-body">
                <div class="row align-items-end">
                    <div class="col">
                        <a href="{{ url('admin/law-dictionary') }}" class="text-color mb-4"><i
                    ...
                    <div class="card-body p-5">
                        <form action="{{ route('update.dictionary', $word->id) }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="content" id="summernote" rows="5" class="form-control" placeholder="Enter description">{{ $word->content }}</textarea>
                            </div>
                            <div class="form-group">
                                <label class="form-label mb-1">
                                    Category
