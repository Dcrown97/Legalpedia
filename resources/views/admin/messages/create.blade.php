        ...
        <div class="container-fluid">
            <div class="header-body">
                <div class="row align-items-end">
                    <div class="col">
                        <a href="{{ url('admin/messages') }}" class="text-color mb-4"><i class="fe fe-arrow-left mr-2"></i>
                            Back</a>
            ...
            <div class="col-12 col-lg-10 col-xl-8">
                <form action="{{ route('store.message') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select name="type" id="message_type" class="form-select"
                            onchange="showDiv('normal', 'auto', this)">
                    ...
                    <div id="normal" style="display: none">
                        <div class="form-group">
                            ...
                            <input type="text" name="receipient" class="form-control"
                                placeholder="e.g Customers with active Subscription">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="body" rows="5" class="form-control" id="summernote"
                            placeholder="e.g Hello Emmanuel, You can now access thousands of records of recent and old Judgments, Laws, Rules, Articles and so much more!"></textarea>
                    </div>
                    <div class="form-group">
