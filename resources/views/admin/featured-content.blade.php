            ...
            <div class="col-12">
                <div class="tab-content" id="wizardSteps">
                                ...
                                <div class="row list">
                                    @if(count($featured_teams) > 0)
                                                        ...
                                                        <div class="row align-items-center">
                                                           ...
                                                           <div class="col-auto">
                                                               @if($featured_team->featured == 1)
                                                                    <form action="{{route('admin.save-feature', $featured_team->reference_id)}}" method="POST">
                                                                        @csrf
                                                                        <input type="hidden" name="featured" value="0">
                                                                        <input type="hidden" name="type" value="team">
                                                                        <button type="submit" name="remove_featured" class="btn btn-custom" onclick="this.classList.toggle('button--loading')">
                                                                            <span class="button__text"><i class="mdi mdi-close"></i>Remove Featured</span>
                                                                        </button>
                                                                    </form>
                                                                @elseif($featured_team->featured == 0)
                                                                    <form action="{{route('admin.save-feature', $featured_team->reference_id)}}" method="POST">
                                                                        ...
                                                                        <input type="hidden" name="type" value="team">
                                                                        <button type="submit" name="make_featured" class="btn btn-primary" onclick="this.classList.toggle('button--loading')">
                                                                            <span class="button__text"><i class="mdi mdi-check"></i>Make Featured</span>
                                                                        </button>
                                                                    </form>
                                                                @endif
                                                            </div>
                                        ...
                                        <div class="text-center mt-8 mb-8">
                                            <h3 class="text-muted"><i class="fe fe-users"></i> There are no featured teams</h3>
                                        </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="card" data-list='{"valueNames": ["item-name"], "page": 10, "pagination": {"paginationClass": "list-pagination"}}' id="contactsLists">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <ul id="table_data" class="list-group table_data list-group-lg list-group-flush list my-n4">
                                                @foreach($featured_users as $featured_user)
                                                    <li class="list-group-item">
                                                        <div class="row align-items-center">
                                                            <div class="col-auto">
                                                                <?php $user = App\Models\User::where('id', $featured_user->reference_id)->first(); ?>
                                                            ...
                                                            <div class="col ms-n2">
                                                                ...
                                                                <span class="mb-4">
                                                                    @php
                                                                        ...
                                                                        $rating = App\Models\FeaturedContent::where('type', 'user')->where('review_type', 'rating')->where('reference_id', $featured_user->reference_id)->max('rating');
                                                                    @endphp
                                                                    @if ($rating_count > 0)
                                                            ...
                                                            <div class="col-auto">
                                                                @if($featured_user->featured == 1)
                                                                    <form action="{{route('admin.save-feature', $featured_user->reference_id)}}" method="POST">
                                                                        @csrf
                                                                    <input type="hidden" name="featured" value="0">
                                        ...
                                        @else
                                            <div class="text-center mt-8 mb-8">
                                                <h3 class="text-muted"><i class="fe fe-users"></i> There are no featured users</h3>
                                            </div>
                                        @endif
                                    </div>
                                    <div class="row g-0">
                    ...
                    <div class="tab-pane fade" id="article" role="tabpanel" aria-labelledby="article-tab">
                        <div class="card" data-list='{"valueNames": ["item-name1"], "page": 10, "pagination": {"paginationClass": "list-pagination"}}' id="contactsList">
                            {{-- <div class="card-header">
                                <form>
                                <div class="input-group input-group-flush input-group-merge input-group-reverse">
                            ...
                            <div class="card-body">
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-auto">
                                                        @if($featured_article->featured == 1)
                                                             <form action="{{route('admin.save-feature', $featured_article->reference_id)}}" method="POST">
                                                                 @csrf
                                                                 <input type="hidden" name="featured" value="0">
                                ...
                                @else
                                    <div class="text-center">
                                        <h3 class="text-muted"><i class="fe fe-file"></i> There are no featured articles</h3>
                                    </div>
                                @endif
                            </div>
                            <!-- Pagination -->
                    ...
                    <div class="tab-pane fade" id="form" role="tabpanel" aria-labelledby="form-tab">
                        <div class="card" data-list='{"valueNames": ["item-name2"], "page": 10, "pagination": {"paginationClass": "list-pagination"}}' id="contactsListss">
                            {{-- <div class="card-header">
                                <div class="row align-items-center">
                                    <div class="col">
                                        <form>
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-auto">
                                                        @if($featured_form->featured == 1)
                                                             <form action="{{route('admin.save-feature', $featured_form->reference_id)}}" method="POST">
                                                                 @csrf
                                                                 <input type="hidden" name="featured" value="0">
                    ...
                    <div class="tab-pane fade" id="note" role="tabpanel" aria-labelledby="note-tab">
                        <div class="card" data-list='{"valueNames": ["item-name3"], "page": 10, "pagination": {"paginationClass": "list-pagination"}}' id="contactsLi">
                            {{-- <div class="card-header">
                                <form>
                                <div class="input-group input-group-flush input-group-merge input-group-reverse">
                                    <input class="form-control list-search" type="search" placeholder="Search">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-auto">
                                                                @if($featured_note->featured == 1)
                                                                    <form action="{{route('admin.save-feature', $featured_note->reference_id)}}" method="POST">
                                                                        @csrf
                                                                        <input type="hidden" name="featured" value="0">
                                                                        <input type="hidden" name="type" value="note">
                                                                        <button type="submit" name="remove_featured" class="btn btn-custom mb-4" onclick="this.classList.toggle('button--loading')">
                                                                            <span class="button__text"><i class="mdi mdi-close"></i>Remove Featured</span>
                                                                        </button>
                                                                    </form>
                                                                @elseif($featured_note->featured == 0)
                                                                    <form action="{{route('admin.save-feature', $featured_note->reference_id)}}" method="POST">
                                                                        ...
                                                                        <input type="hidden" name="featured" value="1">
                                                                        <input type="hidden" name="type" value="note">
                                                                        <button type="submit" name="make_featured" class="btn btn-primary mb-4" onclick="this.classList.toggle('button--loading')">
                                                                            <span class="button__text"><i class="mdi mdi-check"></i>Make Featured</span>
                                                                        </button>
                                                                    </form>
                                                                @endif
