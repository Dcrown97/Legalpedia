            ...
            <div class="col-12 col-lg-12 col-xl-12">
                <div class="card">
                    <div class="card-body p-5">
                        @if($order)
                            <form action="{{route('update.rule', $order->id)}}" method="post">
                                {{ csrf_field() }}
                                {{ method_field('patch') }}
                                <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="content" class="form-control" id="summernote4" rows="5" placeholder="Enter description">{{$order->content}}</textarea>
                                </div>
                                <div class="form-group">
                            ...
                            @elseif($schedule)
                            <form action="{{route('update.rule', $schedule->id)}}" method="post">
                                {{ csrf_field() }}
                                {{ method_field('patch') }}
                                <div class="row">
                                    <div class="col-12 col-lg-6 col-xl-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="content" rows="5" id="summernote5" class="form-control" placeholder="Enter description">{{$schedule->content}}</textarea>
                                </div>
                                <div class="form-group">
                                    <button type="submit" name="submit" onclick="this.classList.toggle('button--loading')" class="button_load btn btn-primary text-white">
                                        <span class="button__text"><i class="mdi mdi-check"></i> Save</span>
                            ...
                            @elseif($form)
                            <form action="{{route('update.rule', $form->id)}}" method="post">
                                {{ csrf_field() }}
                                {{ method_field('patch') }}
                                <div class="row">
                                    <div class="col-12 col-lg-6 col-xl-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="content" rows="5" id="summernote6" class="form-control" placeholder="Enter description">{{$form->content}}</textarea>
                                </div>
                                <div class="form-group">
                                    <button type="submit" name="submit" onclick="this.classList.toggle('button--loading')" class="button_load btn btn-primary text-white">
                                        <span class="button__text"><i class="mdi mdi-check"></i> Save</span>
                            ...
                            @elseif($part)
                            <form action="{{route('update.rule', $part->id)}}" method="post">
                                {{ csrf_field() }}
                                {{ method_field('patch') }}
                                <div class="row">
                                    <div class="col-12 col-lg-6 col-xl-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="content" rows="5" id="summernote1" class="form-control" placeholder="Enter description">{{$part->content}}</textarea>
                                </div>
                                <div class="form-group">
                                    <button type="submit" name="submit" onclick="this.classList.toggle('button--loading')" class="button_load btn btn-primary text-white">
                                        <span class="button__text"><i class="mdi mdi-check"></i> Save</span>
                            ...
                            @elseif($probate_form)
                            <form action="{{route('update.rule', $probate_form->id)}}" method="post">
                                {{ csrf_field() }}
                                {{ method_field('patch') }}
                                <div class="row">
                                    <div class="col-12 col-lg-6 col-xl-6">
                            ...
                            @elseif($civil_form)
                            <form action="{{route('update.rule', $civil_form->id)}}" method="post">
                                {{ csrf_field() }}
                                {{ method_field('patch') }}
                                <div class="row">
                                    <div class="col-12 col-lg-6 col-xl-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="content" rows="5" id="summernote2" class="form-control" placeholder="Enter description">{{$civil_form->content}}</textarea>
                                </div>
                                <div class="form-group">
                                    <button type="submit" name="submit" onclick="this.classList.toggle('button--loading')" class="button_load btn btn-primary text-white">
                                        <span class="button__text"><i class="mdi mdi-check"></i> Save</span>
                            ...
                            @elseif($appendix)
                            <form action="{{route('update.rule', $appendix->id)}}" method="post">
                                {{ csrf_field() }}
                                {{ method_field('patch') }}
                                <div class="row">
                                    <div class="col-12 col-lg-6 col-xl-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="content" rows="5" id="summernote3" class="form-control" placeholder="Enter description">{{$appendix->content}}</textarea>
                                </div>
                                <div class="form-group">
                                    <button type="submit" name="submit" onclick="this.classList.toggle('button--loading')" class="button_load btn btn-primary text-white">
                                        <span class="button__text"><i class="mdi mdi-check"></i> Save</span>
