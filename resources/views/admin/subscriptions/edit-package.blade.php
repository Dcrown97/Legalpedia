                ...
                <div class="card-body p-5">
                    <form class="tab-content pb-4" id="wizardSteps" action="{{ route('update.package', $package->id) }}" method="POST">
                                ...
                                <div class="col-12 col-lg-6 col-xl-6">
                                    <div class="form-group">
                                        ...
                                        <select name="validity" class="form-select">
                                            <option value="{{ $package->validity }}" selected>{{ $package->validity }}
                                            </option>
                        ...
                        <div class="tab-pane fade" id="wizardStepTwo" role="tabpanel" aria-labelledby="wizardTabTwo">
                            ...
                            @if ($package->api_access !== null)
                            <div id="showApiAccess">
                                <div class="form-group">
                                    <div class="form-check mb-n2">
                                        <input class="form-check-input list-checkbox" name="judgement_featureapi" type="checkbox" id="judgementCheck" value="judgementapi" {{ $package->judgement_featureapi !== null ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="form-check mb-n2">
                                        <input class="form-check-input list-checkbox" name="lfn_featureapi" type="checkbox" id="lfnCheck" value="lfnapi" {{ $package->lfn_featureapi !== null ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="form-check mb-n2">
                                        <input class="form-check-input list-checkbox" type="checkbox" name="roc_featureapi" id="rocCheck" value="rule of court api" {{ $package->roc_featureapi !== null ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="form-check mb-n2">
                                        <input class="form-check-input list-checkbox" name="sroc_featureapi" type="checkbox" id="srocCheck" value="state rule of court api" {{ $package->sroc_featureapi !== null ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="form-check mb-n2">
                                        <input class="form-check-input list-checkbox" type="checkbox" name="form_featureapi" id="formCheck" value="formsapi" {{ $package->form_featureapi !== null ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="form-check mb-n2">
                                        <input class="form-check-input list-checkbox" type="checkbox" name="article_featureapi" id="articleCheck" value="articleapi" {{ $package->article_featureapi !== null ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="form-check mb-n2">
                                        <input class="form-check-input list-checkbox" type="checkbox" name="maxim_featureapi" id="maximCheck" value="maximapi" {{ $package->maxim_featureapi !== null ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="form-check mb-n2">
                                        <input class="form-check-input list-checkbox" type="checkbox" name="dict_featureapi" id="dictCheck" value="dictionaryapi" {{ $package->dict_featureapi !== null ? 'checked' : '' }}>
                                ...
                                {{-- <div class="form-group">
                                            <div class="form-check mb-n2">
                                                <input class="form-check-input list-checkbox" type="checkbox"
                                                    name="resource_featureapi" id="resourceCheck" value="resourceapi"
                                                    {{ $package->resource_featureapi !== null ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            <div class="form-check mb-n2">
                                <input class="form-check-input list-checkbox" type="checkbox" name="ai_featureapi" id="aiCheck" value="aiapi" {{ $package->ai_featureapi !== null ? 'checked' : '' }}>
                                ...
                                <div class="col-12 col-lg-6 col-xl-6">
                                    <div class="form-group">
                                        ...
                                        <select multiple name="judg_cat[]" id="judg-cat" class="form-select form-select-sm form-control-flush" data-choices='{"searchEnabled": true}'>
                                            ...
                                            <option value="{{ $category->category }}" @if ($judg_cat) {{ in_array($category->category, $judg_cat) ? 'selected' : '' }} @endif>
                                                {{ $category->category }}
                                            </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-12 col-lg-6 col-xl-6">
                                    <div class="form-group">
                                        ...
                                        <select multiple name="judg_court[]" class="form-select form-select-sm form-control-flush" data-choices='{"searchEnabled": true}'>
                                            ...
                                            <option value="{{ $court->court }}" @if ($judg_court) {{ in_array($court->court, $judg_court) ? 'selected' : '' }} @endif>
                                                {{ $court->court }}
                                            </option>
                                            @endforeach
                                        </select>
...
<<<<<<< HEAD
                                @else
                                    <div id="showWebAccess">
                                        <div class="form-group">
                                            <div class="form-check mb-n2">
                                                <input class="form-check-input list-checkbox" name="judgement_feature"
                                                    type="checkbox" id="judgementCheck" value="judgement"
                                                    {{ $package->judgement_feature !== null ? 'checked' : '' }}>
                                                <h5 class="pt-2 pl-2">Judgements</h5>
                                                <label class="form-check-label" for="ordersSelectOne">&nbsp;</label>
                                            </div>
                                            @if ($package->judgement_feature !== null)
                                                <div id="show_judgement_content">
                                                    <div class="select_type">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-select" id="year_type"
                                                                onchange="showDiv('single', 'range', this)">
                                                                <option value="single">Single Year</option>
                                                                <option value="range">Year range</option>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div id="single">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" min="1960" name="judg_single_year"
                                                                placeholder="1960" class="form-control"
                                                                value="{{ $package->judg_single_year }}">
                                                        </div>
                                                    </div>
                                                    <div id="range" style="display: none">
                                                        <div class="row">
                                                            <div class="col-12 col-lg-6 col-xl-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" min="1960"
                                                                        name="judg_start_year" placeholder="1960"
                                                                        class="form-control"
                                                                        value="{{ $package->judg_start_year }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-12 col-lg-6 col-xl-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <?php $current_year = date('Y'); ?>
                                                                    <input type="number" max="{{ $current_year }}"
                                                                        name="judg_end_year"
                                                                        placeholder="{{ $current_year }}"
                                                                        class="form-control"
                                                                        value="{{ $package->judg_end_year }}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-12 col-lg-6 col-xl-6">
                                                            <div class="form-group">
                                                                ...
                                                                @php
                                                                    $judg_cat = json_decode($package->judg_cat);
                                                                @endphp
                                                                <select multiple name="judg_cat[]" id="judg-cat"
                                                                    class="form-select form-select-sm form-control-flush"
                                                                    data-choices='{"searchEnabled": true}'>
                                                                    <option value="">Select Category</option>
                                                                    @foreach ($categories as $category)
                                                                        <option value="{{ $category->category }}"
                                                                            @if ($judg_cat) {{ in_array($category->category, $judg_cat) ? 'selected' : '' }} @endif>
                                                        ...
                                                        <div class="col-12 col-lg-6 col-xl-6">
                                                            <div class="form-group">
                                                                ...
                                                                @php
                                                                    $judg_court = json_decode($package->judg_court);
                                                                @endphp
                                                                <select multiple name="judg_court[]"
                                                                    class="form-select form-select-sm form-control-flush"
                                                                    data-choices='{"searchEnabled": true}'>
                                                                    <option value="">Select Court</option>
                                                                    @foreach ($courts as $court)
                                                                        <option value="{{ $court->court }}"
                                                                            @if ($judg_court) {{ in_array($court->court, $judg_court) ? 'selected' : '' }} @endif>
                                                                            {{ $court->court }}</option>
                                                                    @endforeach
                                                                </select>
                                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-check mb-n2">
                                                <input class="form-check-input list-checkbox" name="lfn_feature"
                                                    ...
                                                    {{ $package->lfn_feature !== null ? 'checked' : '' }}>
                                                <h5 class="pt-2 pl-2">Law of Federation</h5>
                                                <label class="form-check-label" for="ordersSelectOne">&nbsp;</label>
                                            </div>
                                                ...
                                                <div id="show_lfn_content">
                                                    <div class="select_type">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-select" id="year"
                                                                onchange="showYear('single_year', 'year_range', this)">
                                                    ...
                                                    <div id="single_year">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" name="lfn_single_year" min="1960"
                                                                placeholder="1960" class="form-control"
                                                                value="{{ $package->lfn_single_year }}">
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12 col-lg-6 col-xl-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" min="1960"
                                                                        name="lfn_start_year" placeholder="1960"
                                                                        class="form-control"
                                                                        value="{{ $package->lfn_start_year }}">
                                                                </div>
                                                            </div>
                                                            <div class="col-12 col-lg-6 col-xl-6">
                                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        @endphp
                                                        <select name="lfn_cat[]" multiple
                                                            class="form-select form-select-sm form-control-flush"
                                                            data-choices='{"searchEnabled": true}'>
                                                            <option value="">Select Category</option>
                                                            @foreach ($categories as $category)
                                                                <option value="{{ $category->category }}"
                                                                    @if ($lfn_cat) {{ in_array($category->category, $lfn_cat) ? 'selected' : '' }} @endif>
                                                                    {{ $category->category }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-check mb-n2">
                                                <input class="form-check-input list-checkbox" type="checkbox"
                                                    name="roc_feature" id="rocCheck" value="rule of court"
                                                    {{ $package->roc_feature !== null ? 'checked' : '' }}>
                                                <h5 class="pt-2 pl-2">Rule of Court</h5>
                                                <label class="form-check-label" for="ordersSelectOne">&nbsp;</label>
                                            </div>
                                            @if ($package->roc_feature !== null)
                                                <div id="show_roc_content">
                                                    <div class="form-group">
                                                        ...
                                                        @endphp
                                                        <select name="roc_cat[]" multiple
                                                            class="form-select form-select-sm form-control-flush"
                                                            data-choices='{"searchEnabled": true}'>
                                                            <option value="">Select rule category</option>
                                                            @foreach ($rule_categories as $category)
                                                                <option value="{{ $category->name }}"
                                                                    @if ($roc_cat) {{ in_array($category->name, $roc_cat) ? 'selected' : '' }} @endif>
                                        ...
                                        <div class="form-group">
                                            <div class="form-check mb-n2">
                                                <input class="form-check-input list-checkbox" name="sroc_feature"
                                                    type="checkbox" id="srocCheck" value="state rule of court"
                                                    {{ $package->sroc_feature !== null ? 'checked' : '' }}>
                                                <h5 class="pt-2 pl-2">State Rule of Court</h5>
                                                <label class="form-check-label" for="ordersSelectOne">&nbsp;</label>
                                            </div>
                                            @if ($package->sroc_feature !== null)
                                                <div id="show_sroc_content">
                                                    <div class="form-group">
                                                        ...
                                                        @endphp
                                                        <select name="sroc_state[]" multiple
                                                            class="form-select form-select-sm form-control-flush"
                                                            data-choices='{"searchEnabled": true}'>
                                                            <option value="">Select State</option>
                                                            @foreach ($states as $state)
                                                                <option value="{{ $state->name }}"
                                                                    @if ($sroc_state) {{ in_array($state->name, $sroc_state) ? 'selected' : '' }} @endif>
                                                                    {{ $state->name }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-check mb-n2">
                                                <input class="form-check-input list-checkbox" type="checkbox"
                                                    name="form_feature" id="formCheck" value="forms"
                                                    {{ $package->form_feature !== null ? 'checked' : '' }}>
                                                <h5 class="pt-2 pl-2">Forms and Precedence</h5>
                                                <label class="form-check-label" for="ordersSelectOne">&nbsp;</label>
                                            </div>
                                            @if ($package->form_feature !== null)
                                                <div id="show_form_content">
                                                    <div class="form-group">
                                                        ...
                                                        @endphp
                                                        <select name="form_cat[]" multiple
                                                            class="form-select form-select-sm form-control-flush"
                                                            data-choices='{"searchEnabled": true}'>
                                                            <option value="">Select Category</option>
                                                            @foreach ($categories as $category)
                                                                <option value="{{ $category->category }}"
                                                                    @if ($form_cat) {{ in_array($category->category, $form_cat) ? 'selected' : '' }} @endif>
                                                                    {{ $category->category }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-check mb-n2">
                                                <input class="form-check-input list-checkbox" type="checkbox"
                                                    name="article_feature" id="articleCheck" value="article"
                                                    {{ $package->article_feature !== null ? 'checked' : '' }}>
                                                <h5 class="pt-2 pl-2">Legal Articles</h5>
                                                <label class="form-check-label" for="ordersSelectOne">&nbsp;</label>
                                            </div>
                                            @if ($package->article_feature !== null)
                                                <div id="show_article_content">
                                                    <div class="form-group">
                                                        ...
                                                        @endphp
                                                        <select name="article_cat[]" multiple
                                                            class="form-select form-select-sm form-control-flush"
                                                            data-choices='{"searchEnabled": true}'>
                                                            <option value="">Select Category</option>
                                                            @foreach ($categories as $category)
                                                                <option value="{{ $category->category }}"
                                                                    @if ($article_cat) {{ in_array($category->category, $article_cat) ? 'selected' : '' }} @endif>
                                                                    {{ $category->category }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-check mb-n2">
                                                <input class="form-check-input list-checkbox" type="checkbox"
                                                    name="maxim_feature" id="maximCheck" value="maxim"
                                                    {{ $package->maxim_feature !== null ? 'checked' : '' }}>
                                                <h5 class="pt-2 pl-2">Legal Maxims</h5>
                                                <label class="form-check-label" for="ordersSelectOne">&nbsp;</label>
                                            </div>
                                            @if ($package->maxim_feature !== null)
                                                <div id="show_maxim_content">
                                                    <div class="form-group">
                                                        ...
                                                        @endphp
                                                        <select name="maxim_cat[]" multiple
                                                            class="form-select form-select-sm form-control-flush"
                                                            data-choices='{"searchEnabled": true}'>
                                                            <option value="">Select Category</option>
                                                            @foreach ($categories as $category)
                                                                <option value="{{ $category->category }}"
                                                                    @if ($maxim_cat) {{ in_array($category->category, $maxim_cat) ? 'selected' : '' }} @endif>
                                                                    {{ $category->category }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                            ...
                                            @if ($package->dict_feature !== null)
                                                <div id="show_dict_content">
                                                    <div class="form-group">
                                                        ...
                                                        @endphp
                                                        <select name="dict_cat[]" multiple
                                                            class="form-select form-select-sm form-control-flush"
                                                            data-choices='{"searchEnabled": true}'>
                                                            <option value="">Select Category</option>
                                                            @foreach ($categories as $category)
                                                                <option value="{{ $category->category }}"
                                                                    @if ($dict_cat) {{ in_array($category->category, $dict_cat) ? 'selected' : '' }} @endif>
                                                                    {{ $category->category }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-check mb-n2">
                                                <input class="form-check-input list-checkbox" type="checkbox"
                                                    name="resource_feature" id="resourceCheck" value="resource"
                                                    {{ $package->resource_feature !== null ? 'checked' : '' }}>
                                                <h5 class="pt-2 pl-2">Foreign Resources</h5>
                                                <label class="form-check-label" for="ordersSelectOne">&nbsp;</label>
                                            </div>
                                            @if ($package->resource_feature !== null)
                                                <div id="show_resource_content">
                                                    <div class="form-group">
                                                        ...
                                                        @endphp
                                                        <select name="resource_cat[]" multiple
                                                            class="form-select form-select-sm form-control-flush"
                                                            data-choices='{"searchEnabled": true}'>
                                                            <option value="">Select Category</option>
                                                            @foreach ($categories as $category)
                                                                <option value="{{ $category->category }}"
                                                                    @if ($resource_cat) {{ in_array($category->category, $resource_cat) ? 'selected' : '' }} @endif>
                                                                    {{ $category->category }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
...
>>>>>>> bd129319de83c81b6fae0535d1db137ba4d2372d
                        ...
                        <div id="show_lfn_content">
                            ...
                            <div class="form-group">
                                ...
                                <select name="lfn_cat[]" multiple class="form-select form-select-sm form-control-flush" data-choices='{"searchEnabled": true}'>
                                    <option value="">Select Category</option>
                                    @foreach ($categories as $category)
                                    <option value="{{ $category->category }}" @if ($lfn_cat) {{ in_array($category->category, $lfn_cat) ? 'selected' : '' }} @endif>
                                        {{ $category->category }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div id="show_roc_content">
                            <div class="form-group">
                                ...
                                <select name="roc_cat[]" multiple class="form-select form-select-sm form-control-flush" data-choices='{"searchEnabled": true}'>
                                    <option value="">Select rule category</option>
                                    @foreach ($rule_categories as $category)
                                    <option value="{{ $category->name }}" @if ($roc_cat) {{ in_array($category->name, $roc_cat) ? 'selected' : '' }} @endif>
                                        {{ $category->name }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div id="show_sroc_content">
                            <div class="form-group">
                                ...
                                <select name="sroc_state[]" multiple class="form-select form-select-sm form-control-flush" data-choices='{"searchEnabled": true}'>
                                    <option value="">Select State</option>
                                    @foreach ($states as $state)
                                    <option value="{{ $state->name }}" @if ($sroc_state) {{ in_array($state->name, $sroc_state) ? 'selected' : '' }} @endif>
                                        {{ $state->name }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div id="show_form_content">
                            <div class="form-group">
                                ...
                                <select name="form_cat[]" multiple class="form-select form-select-sm form-control-flush" data-choices='{"searchEnabled": true}'>
                                    <option value="">Select Category</option>
                                    @foreach ($categories as $category)
                                    <option value="{{ $category->category }}" @if ($form_cat) {{ in_array($category->category, $form_cat) ? 'selected' : '' }} @endif>
                                        {{ $category->category }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div id="show_article_content">
                            <div class="form-group">
                                ...
                                <select name="article_cat[]" multiple class="form-select form-select-sm form-control-flush" data-choices='{"searchEnabled": true}'>
                                    <option value="">Select Category</option>
                                    @foreach ($categories as $category)
                                    <option value="{{ $category->category }}" @if ($article_cat) {{ in_array($category->category, $article_cat) ? 'selected' : '' }} @endif>
                                        {{ $category->category }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div id="show_maxim_content">
                            <div class="form-group">
                                ...
                                <select name="maxim_cat[]" multiple class="form-select form-select-sm form-control-flush" data-choices='{"searchEnabled": true}'>
                                    <option value="">Select Category</option>
                                    @foreach ($categories as $category)
                                    <option value="{{ $category->category }}" @if ($maxim_cat) {{ in_array($category->category, $maxim_cat) ? 'selected' : '' }} @endif>
                                        {{ $category->category }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div id="show_dict_content">
                            <div class="form-group">
                                ...
                                <select name="dict_cat[]" multiple class="form-select form-select-sm form-control-flush" data-choices='{"searchEnabled": true}'>
                                    <option value="">Select Category</option>
                                    @foreach ($categories as $category)
                                    <option value="{{ $category->category }}" @if ($dict_cat) {{ in_array($category->category, $dict_cat) ? 'selected' : '' }} @endif>
                                        {{ $category->category }}
                                    </option>
                                    @endforeach
                                </select>
                        ...
                        <div id="show_resource_content">
                            <div class="form-group">
                                ...
                                <select name="resource_cat[]" multiple class="form-select form-select-sm form-control-flush" data-choices='{"searchEnabled": true}'>
                                    <option value="">Select Category</option>
                                    @foreach ($categories as $category)
                                    <option value="{{ $category->category }}" @if ($resource_cat) {{ in_array($category->category, $resource_cat) ? 'selected' : '' }} @endif>
                                        {{ $category->category }}
                                    </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="form-group">
                        ...
                        <div id="show_ai_content">
                            <div class="form-group">
                                ...
                                @php
                                $resource_cat = json_decode($package->ai_cat);
                                @endphp
                    ...
                    <div class="form-group">
                        <div class="form-check mb-n2">
                            <input class="form-check-input list-checkbox" type="checkbox" name="ai_counsel" id="aiCounselCheck" value="ai_counsel" {{ $package->ai_counsel !== NULL ? 'checked' : '' }}>
                            <h5 class="pt-2 pl-2">AI Counsel</h5>
                            <label class="form-check-label" for="ordersSelectOne">&nbsp;</label>
                        </div>
                        @if($package->ai_counsel !== NULL)
                        <div id="show_ai_counsel">
                            <div class="form-group">
                                <label class="form-label mb-1">
                                    Category
                                </label>
                                @php
                                $resource_cat = json_decode($package->ai_counsel_cat);
                                @endphp
                                <select name="ai_cat[]" multiple class="form-select form-select-sm form-control-flush" data-choices='{"searchEnabled": true}'>
                                    <option value="">Select Category</option>
                                    @foreach($categories as $category)
                        ...
                        @else
                        <div id="show_ai_counsel" style="display: none">
                            <div class="form-group">
                                <label class="form-label mb-1">
                                    Category
                                </label>
                                <select name="ai_counsel_cat[]" multiple class="form-select form-select-sm form-control-flush" data-choices='{"searchEnabled": true}'>
                                    <option value="">Select Category</option>
                                    @foreach($categories as $category)
            ...
            <div class="tab-pane fade" id="wizardStepThree" role="tabpanel" aria-labelledby="wizardTabThree">
                ...
                <div class="form-group">
                    <div class="form-check mb-n2">
                        <input class="form-check-input list-checkbox" name="api_access" type="checkbox" value="api_access" {{ $package->api_access !== null ? 'checked' : '' }}>
                        <h5 class="pt-2 pl-2">Grant API Access</h5>
                        <label class="form-check-label" for="ordersSelectOne">&nbsp;</label>
                    </div>
                </div>
                <div class="form-group priceamount">
                    ...
                    <input type="text" name="postman_link" class="form-control" value="{{ $package->postman_link }}">
                </div>
                <div class="form-group">
                    <label class="form-label mb-1">
...
>>>>>>> bd129319de83c81b6fae0535d1db137ba4d2372d
        ...
        $("#aiCounselCheck").click(function() {
            if ($(this).is(":checked")) {
                $("#show_ai_counsel").show();
            } else {
                $("#show_ai_counsel").hide();
            }
        });
    });
</script>
