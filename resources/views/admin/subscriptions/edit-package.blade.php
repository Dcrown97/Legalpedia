        ...
        <div class="container-fluid">
            <div class="header-body">
                <div class="row align-items-end">
                    <div class="col">
                        <a href="{{ url('admin/subscriptions') }}" class="text-color mb-4"><i
            ...
            <div class="col-12 col-lg-12 col-xl-12">
                <div class="card">
                    <div class="card-body p-5">
                        <form class="tab-content pb-4" id="wizardSteps" action="{{ route('update.package', $package->id) }}"
                            method="POST">
                            {{ csrf_field() }}
                            {{ method_field('patch') }}
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-6 col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="recur_date" value="{{ $package->recur_date }}"
                                ...
                                <div class="nav row align-items-center">
                                    ...
                                    <div class="col-auto">
                                        <a class="btn text-white btn-primary" data-toggle="wizard"
                                            href="#wizardStepTwo">Next <i class="mdi mdi-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div id="showApiAccess">
                                        <div class="form-group">
                                            <div class="form-check mb-n2">
                                                <input class="form-check-input list-checkbox" name="judgement_featureapi"
                                                    type="checkbox" id="judgementCheck" value="judgementapi"
                                                    {{ $package->judgement_featureapi !== null ? 'checked' : '' }}>
                                        ...
                                        <div class="form-group">
                                            <div class="form-check mb-n2">
                                                <input class="form-check-input list-checkbox" name="lfn_featureapi"
                                                    ...
                                                    {{ $package->lfn_featureapi !== null ? 'checked' : '' }}>
                                        ...
                                        <div class="form-group">
                                            <div class="form-check mb-n2">
                                                <input class="form-check-input list-checkbox" type="checkbox"
                                                    name="roc_featureapi" id="rocCheck" value="rule of court api"
                                                    {{ $package->roc_featureapi !== null ? 'checked' : '' }}>
                                        ...
                                        <div class="form-group">
                                            <div class="form-check mb-n2">
                                                <input class="form-check-input list-checkbox" name="sroc_featureapi"
                                                    type="checkbox" id="srocCheck" value="state rule of court api"
                                                    {{ $package->sroc_featureapi !== null ? 'checked' : '' }}>
                                        ...
                                        <div class="form-group">
                                            <div class="form-check mb-n2">
                                                <input class="form-check-input list-checkbox" type="checkbox"
                                                    name="form_featureapi" id="formCheck" value="formsapi"
                                                    {{ $package->form_featureapi !== null ? 'checked' : '' }}>
                                        ...
                                        <div class="form-group">
                                            <div class="form-check mb-n2">
                                                <input class="form-check-input list-checkbox" type="checkbox"
                                                    name="article_featureapi" id="articleCheck" value="articleapi"
                                                    {{ $package->article_featureapi !== null ? 'checked' : '' }}>
                                        ...
                                        <div class="form-group">
                                            <div class="form-check mb-n2">
                                                <input class="form-check-input list-checkbox" type="checkbox"
                                                    name="maxim_featureapi" id="maximCheck" value="maximapi"
                                                    {{ $package->maxim_featureapi !== null ? 'checked' : '' }}>
                                        ...
                                        <div class="form-group">
                                            <div class="form-check mb-n2">
                                                <input class="form-check-input list-checkbox" type="checkbox"
                                                    name="ai_featureapi" id="aiCheck" value="aiapi"
                                                    {{ $package->ai_featureapi !== null ? 'checked' : '' }}>
                                ...
                                @else
                                    <div id="showWebAccess">
                                        ...
                                        <div class="form-group">
                                            <div class="form-check mb-n2">
                                                <input class="form-check-input list-checkbox" type="checkbox"
                                                    name="ai_feature" id="aiCheck" value="ai"
                                                    {{ $package->ai_feature !== null ? 'checked' : '' }}>
                                                <h5 class="pt-2 pl-2">LegalpediaLens</h5>
                                                <label class="form-check-label" for="ordersSelectOne">&nbsp;</label>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <div class="form-check mb-n2">
                                                <input class="form-check-input list-checkbox" type="checkbox"
                                                    name="ai_counsel" id="aiCounselCheck" value="ai_counsel"
                                                    {{ $package->ai_counsel !== null ? 'checked' : '' }}>
                                            ...
                                            @else
                                                <div id="show_ai_counsel" style="display: none">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="ai_counsel_cat[]" multiple
                                                            class="form-select form-select-sm form-control-flush"
                                                            data-choices='{"searchEnabled": true}'>
                                                            <option value="">Select Category</option>
                                                            @foreach ($categories as $category)
                            ...
                            <div class="tab-pane fade" id="wizardStepThree" role="tabpanel"
                                ...
                                <div class="form-group">
                                    <div class="form-check mb-n2">
                                        <input class="form-check-input list-checkbox" name="team" type="checkbox"
                                            value="team" {{ $package->team !== null ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="form-check mb-n2">
                                        <input class="form-check-input list-checkbox" name="note" type="checkbox"
                                            value="note" {{ $package->note !== null ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="form-check mb-n2">
                                        <input class="form-check-input list-checkbox" name="share" type="checkbox"
                                            value="share" {{ $package->share !== null ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="form-check mb-n2">
                                        <input class="form-check-input list-checkbox" name="api_access" type="checkbox"
                                            value="api_access" {{ $package->api_access !== null ? 'checked' : '' }}>
                                ...
                                <div class="form-group priceamount">
                                    ...
                                    <input type="text" name="postman_link" class="form-control"
                                        value="{{ $package->postman_link }}">
                                </div>
                                <div class="form-group">
                                    <label class="form-label mb-1">
                                    ...
                                    @if ($package->is_active == 1)
                                        <select name="is_active" id="report-type" class="form-select"
                                            onchange="showDiv('show_report', 'report_message', this)">
