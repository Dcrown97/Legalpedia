...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-12">
                <div class="card"
                    data-list='{"valueNames": ["name"], "page": 10, "pagination": {"paginationClass": "list-pagination"}}'
                    id="contactsList">
                    ...
                    <div class="table-responsive">
                        ...
                        @if ($packages)
                            <table class="table table-sm table-nowrap card-table">
                                <thead>
                                    <tr>
                                        <th><a href="#" class="text-muted list-sort" data-sort="orders-order">s/n</a>
                                        </th>
                                        <th><a href="#" class="text-muted list-sort"
                                                data-sort="orders-product">Name</a></th>
                                        <th><a href="#" class="text-muted list-sort"
                                                data-sort="orders-product">Price</a></th>
                                        <th><a href="#" class="text-muted list-sort"
                                                data-sort="orders-product">Duration</a></th>
                                        <th><a href="#" class="text-muted list-sort" data-sort="orders-date">Date
                                                Created</a></th>
                                        <th><a href="#" class="text-muted list-sort" data-sort="orders-total">Package
                                                Link</a></th>
                                        <th><a href="#" class="text-muted list-sort"
                                                data-sort="orders-status">Action</a></th>
                                    </tr>
                                </thead>
                                @foreach ($packages as $package)
                                    <tbody class="list">
                                        <tr>
                                            ...
                                            <td class="orders-total">
                                                {{ \Carbon\Carbon::parse($package->created_at)->toFormattedDateString() }}
                                            </td>
                                            @if ($package->slug)
                                                <td class="orders-total"><a href="{{ route('sub.pack', $package->slug) }}"
                                                        target="_blank">{{ route('sub.pack', $package->slug) }}</a></td>
                                            @else
                                                <td class="orders-total"><a href="{{ url('/subscription-package') }}"
                                                        target="_blank">{{ url('/subscription-package') }}</a></td>
                                            @endif
                                            <td class="text-end">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <form action="/admin/subscriptions/{{ $package->id }}"
                                                            method="POST">
                                                            {{ csrf_field() }}
                                                            {{ method_field('DELETE') }}
                                                            <button type="submit" name="submit"
                                                                onclick="return deleteFunction();" class="dropdown-item">
                ...
                <div class="modal-body scroll-y mt-4">
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-12">
                                <form class="tab-content pb-4" id="wizardSteps" action="{{ route('store.package') }}"
                                    method="POST">
                                    @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-lg-6 col-xl-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="recur_date" placeholder="30"
                                                        class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-pane fade" id="wizardStepTwo" role="tabpanel"
                                        ...
                                        <div class="form-group">
                                            <div class="form-check mb-n2">
                                                <input class="form-check-input list-checkbox webAccess" name="web_access"
                                                    type="radio" id="webAccess" value="web_access">
                                                <h5 class="pt-2 pl-2">Web Access</h5>
                                                {{-- <label class="form-check-label" for="ordersSelectOne">&nbsp;</label> --}}
                                                <input class="form-check-input list-checkbox webAccess" name="web_access"
                                                    type="radio" id="web_access" value="api_access">
                                                <h5 class="pt-2 pl-2">Api Access</h5>
                                                <label class="form-check-label" for="ordersSelectOne">&nbsp;</label>
                                            </div>
                                        </div>
                                        <div class="" id="showWebAccess">
                                            <div class="form-group">
                                                <div class="form-check mb-n2">
                                        ...
                                        <div class="form-group">
                                    <div class="form-check mb-n2">
                                        <input class="form-check-input list-checkbox" type="checkbox" name="ai_counsel" id="aiCounselCheck" value="ai_counsel">
                                ...
                                <hr class="my-5">
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="form-check mb-n2">
                                                    ...
                                                    <h5 class="pt-2 pl-2">Rule of Court Api</h5>
                                                    <label class="form-check-label" for="ordersSelectOne">&nbsp;</label>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="form-check mb-n2">
                                                    ...
                                                    <h5 class="pt-2 pl-2">State Rule of Court Api</h5>
                                                    <label class="form-check-label" for="ordersSelectOne">&nbsp;</label>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="form-check mb-n2">
                                                    ...
                                                    <h5 class="pt-2 pl-2">Forms and Precedence Api</h5>
                                                    <label class="form-check-label" for="ordersSelectOne">&nbsp;</label>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="form-check mb-n2">
                                                    ...
                                                    <h5 class="pt-2 pl-2">Legal Articles Api</h5>
                                                    <label class="form-check-label" for="ordersSelectOne">&nbsp;</label>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="form-check mb-n2">
                                                    ...
                                                    <h5 class="pt-2 pl-2">Legal Maxims Api</h5>
                                                    <label class="form-check-label" for="ordersSelectOne">&nbsp;</label>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="form-check mb-n2">
                                                    ...
                                                    <h5 class="pt-2 pl-2">Law Dictionary Api</h5>
                                                    <label class="form-check-label" for="ordersSelectOne">&nbsp;</label>
                                                </div>
                                            </div>
                                            {{-- <div class="form-group">
                                    ...
                                    <div class="tab-pane fade" id="wizardStepThree" role="tabpanel"
                                        ...
                                        <div class="form-group">
                                            <div class="form-check mb-n2">
                                                <input class="form-check-input list-checkbox" name="team"
                                                    type="checkbox" value="team">
                                        ...
                                        <div class="form-group">
                                            <div class="form-check mb-n2">
                                                <input class="form-check-input list-checkbox" name="note"
                                                    type="checkbox" value="note">
                                        ...
                                        <div class="form-group">
                                            <div class="form-check mb-n2">
                                                <input class="form-check-input list-checkbox" name="share"
                                                    type="checkbox" value="share">
                                        ...
                                        <div class="form-group">
                                            <div class="form-check mb-n2">
                                                <input class="form-check-input list-checkbox" name="api_access"
                                                    type="checkbox" value="api_access">
                                        ...
                                        <div class="form-group priceamount">
                                            ...
                                            <input type="text" name="postman_link" class="form-control" placeholder="https://">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label mb-1">
