...
@section('content')
                                        ...
                                        <ul class="nav nav-tabs nav-overflow header-tabs">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" id="bio-tab" data-toggle="tab" href="#bio"
                                                    role="tab" aria-controls="bio" aria-selected="false">
                                                    Profile Bio
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" id="transact-tab" data-toggle="tab" href="#transact"
                                                    role="tab" aria-controls="transact" aria-selected="false">
                                                    Subscription
                                                </a>
                                            </li>
                                            ...
                                            @elseif(Auth::user()->subscribedUser())
                                                @if ($subscribed_package->api_access)
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="api-tab" data-toggle="tab" href="#api"
                                                            role="tab" aria-controls="api" aria-selected="false">
                                                            API Access Token
                            ...
                            <div class="tab-pane fade show active" id="general" role="tabpanel"
                                ...
                                <form action="{{ route('update.customer', $user->id) }}" method="POST"
                                                ...
                                                <div class="col-auto mr-6">
                                                    <div class="avatar-upload text-center">
                                                        ...
                                                        <div class="avatar-preview">
                                                            @if (Auth::user()->photo)
                                                                <div id="imagePreview"
                                                                    style="background-image: url({{ Auth::user()->photo ? Auth::user()->photo : 'assets/images/user-avatar.jpg' }});">
                                                                </div>
                                                            @else
                                                                <div id="imagePreview"
                                                                    style="background-image: url({{ asset('assets/images/user-avatar.jpg') }});">
                                                                </div>
                                                            @endif
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="phone" value="{{ Auth::user()->phone }}"
                                                    class="form-control mb-3" placeholder="234810xxxxxxxx">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="dob" value="{{ Auth::user()->dob }}"
                                                    class="form-control" data-flatpickr>
                                            </div>
                                        </div>
                                    </div>
                                    <hr class="mt-4 mb-5">
                                    ...
                                    <button type="submit" name="submit"
                                        ...
                                        class="button_load btn btn-primary">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="1960" name="call_to_bar_year"
                                                value="{{ Auth::user()->call_to_bar_year }}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="facebook" placeholder="facebook_handle"
                                                value="{{ Auth::user()->facebook }}" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label"><i class="mdi mdi-instagram"></i> Instagram</label>
                                            <input type="text" name="instagram" placeholder="instagram_handle"
                                                value="{{ Auth::user()->instagram }}" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label"><i class="mdi mdi-twitter"></i> Twitter</label>
                                            <input type="text" name="twitter" placeholder="twitter_handle"
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="web_link" value="{{ Auth::user()->web_link }}"
                                                class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <button type="submit" name="save_bio" onclick="this.classList.toggle('button--loading')"
                                    class="button_load btn btn-primary">
                                    <span class="button__text"><i class="mdi mdi-check"></i> Save changes</span>
                                </button>
                                <hr class="mt-4 mb-5">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-auto">
                                        <div class="form-check mt-2 mb-n2">
                                            <input class="form-check-input list-checkbox" name="email_display"
                                                type="checkbox" value="public"
                                                {{ Auth::user()->email_display !== null ? 'checked' : '' }}>
                                    ...
                                    <div class="col-auto">
                                        <div class="form-check mt-2 mb-n2">
                                            <input class="form-check-input list-checkbox" name="phone_display"
                                                type="checkbox" value="public"
                                                {{ Auth::user()->phone_display !== null ? 'checked' : '' }}>
                                    ...
                                    <div class="col-auto">
                                        <div class="form-check mt-2 mb-n2">
                                            <input class="form-check-input list-checkbox" name="dob_display"
                                                type="checkbox" value="public"
                                                {{ Auth::user()->dob_display !== null ? 'checked' : '' }}>
                                    ...
                                    <div class="col-auto">
                                        <div class="form-check mt-2 mb-n2">
                                            <input class="form-check-input list-checkbox" name="ctb_display"
                                                type="checkbox" value="public"
                                                {{ Auth::user()->ctb_display !== null ? 'checked' : '' }}>
                                    ...
                                    <div class="col-auto">
                                        <div class="form-check mt-2 mb-n2">
                                            <input class="form-check-input list-checkbox" name="social_display"
                                                type="checkbox" value="public"
                                                {{ Auth::user()->social_display !== null ? 'checked' : '' }}>
                                    ...
                                    <div class="col-auto">
                                        <div class="form-check mt-2 mb-n2">
                                            <input class="form-check-input list-checkbox" name="web_display"
                                                type="checkbox" value="public"
                                                {{ Auth::user()->web_display !== null ? 'checked' : '' }}>
                            ...
                            <div class="tab-pane fade" id="transact" role="tabpanel" aria-labelledby="transact-tab">
                                <div class="row">
                                                            ...
                                                            <div class="row mb-4">
                                                                <div class="col-auto">
                                                                    <div class="avatar avatar-sm">
                                                                        <i
                                                                            class="fe fe-check-circle text-success text-30"></i>
                                                                    </div>
                                                                </div>
                                                                <div class="col ms-n2">
                                                                    <h5 class="mb-1">
                                                                    ...
                                                                    <p class="small text-gray-700 mb-0">
                                                                        Expires on
                                                                        {{ \Carbon\Carbon::parse($user->expiry_date)->toFormattedDateString() }}
                                                                    </p>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <a class="mt-4" href="{{ url('admin/pricing') }}">
                                                                        <span
                                                                            class="btn w-100 button_load text-color btn-sm btn-custom p-2"
                                                                            onclick="this.classList.toggle('button--loading')">
                                                                            <span class="button__text"><i
                                                                                    class="mdi mdi-crown"></i> Renew
                                                                                Package</span>
                                                                        </span>
                                                                    </a>
                                                                </div>
                                                    ...
                                                    <div class="list-group list-group-flush list-group-activity my-n3">
                                                        <div class="list-group-item">
                                                            <div class="row mb-4">
                                                                <div class="col ms-n2">
                                                                    <h5 class="mb-1">
                                                                        <i class="mdi mdi-close text-color"></i> You have
                                                            ...
                                                            <div class="row">
                                                                <div class="col-12">
                                                                    <a class="mt-2" href="{{ url('admin/pricing') }}">
                                                                        <span
                                                                            class="btn w-100 button_load text-white btn-sm btn-warning p-2"
                                                                            onclick="this.classList.toggle('button--loading')">
                                                                            <span class="button__text"><i
                                                                                    class="mdi mdi-crown"></i>
                                                                                Subscribe</span>
                                                                        </span>
                                                                    </a>
                                                                </div>
                                    ...
                                    <div class="col-12 col-xl-8">
                                        <div class="card"
                                            data-list='{"valueNames": ["orders-order", "orders-product", "orders-date", "orders-total", "orders-status", "orders-method"], "page": 10, "pagination": {"paginationClass": "list-pagination"}}'
                                            id="contactsList">
                                            <div class="card-header">
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            <th><a href="#" class="text-muted list-sort"
                                                                    data-sort="orders-order">s/n</a></th>
                                                            <th><a href="#" class="text-muted list-sort"
                                                                    data-sort="orders-date">Payment Reference</a></th>
                                                            <th><a href="#" class="text-muted list-sort"
                                                                    data-sort="orders-total">Amount</a></th>
                                                            <th><a href="#" class="text-muted list-sort"
                                                                    data-sort="orders-total">Discounted Price</a></th>
                                                            <th><a href="#" class="text-muted list-sort"
                                                                    data-sort="orders-status">Package</a></th>
                                                            <th><a href="#" class="text-muted list-sort"
                                                                    data-sort="orders-status">Payment Status</a></th>
                                                            <th><a href="#" class="text-muted list-sort"
                                                                    data-sort="orders-status">Payment Date</a></th>
                                                            <th><a href="#" class="text-muted list-sort"
                                                                    data-sort="orders-status">Package Status</a></th>
                                                            <th><a href="#" class="text-muted list-sort"
                                                                    data-sort="orders-status">Package Expiry Date</a></th>
                                                        </tr>
                                                    </thead>
                                                    @php
                                                        $transaction_no = 1;
                                                            ...
                                                            @foreach ($transactions as $transaction)
                                                                <tr>
                                                                    ...
                                                                    @php
                                                                        $transaction_no++;
                                                                    @endphp
                                                                    <td class="orders-date">{{ $transaction->reference }}
                                                                    </td>
                                                                    <td class="orders-date">
                                                                        ₦{{ number_format($transaction->amount, 2) }}</td>
                                                                    <td class="orders-date">
                                                                        ₦{{ number_format($transaction->discounted_price, 2) }}
                                                                    </td>
                                                                    <td class="orders-date">{{ $transaction->package }}
                                                                    </td>
                                                                    <td class="orders-date">{{ $transaction->status }}
                                                                    </td>
                                                                    <td class="orders-total">
                                                                        {{ \Carbon\Carbon::parse($transaction->created_at)->toFormattedDateString() }}
                                                                    </td>
                                                                    @php
                                                                        $package_expiry = App\Models\Package::where(
                                                                            'id',
                                                                        ...
                                                                        if ($package_expiry->validity == 'Days') {
                                                                            ...
                                                                            $expiry_date = $transaction->created_at->addDays(
                                                                                $day,
                                                                            );
                                                                        }
                                                                        if ($package_expiry->validity == 'Months') {
                                                                            $month = $package->recur_date;
                                                                            $expiry_date = $transaction->created_at->addMonths(
                                                                                $month,
                                                                            );
                                                                        }
                                                                        if ($package_expiry->validity == 'Years') {
                                                                            $year = $package->recur_date;
                                                                            $expiry_date = $transaction->created_at->addYears(
                                                                                $year,
                                                                            );
                                                                        }
                                                                    @endphp
                                                                    @if ($transaction->status == 'paid')
                                                                        ...
                                                                        <td class="orders-date">
                                                                            {{ \Carbon\Carbon::parse($expiry_date)->toFormattedDateString() }}
                                                                        </td>
                                                                    @else
                                                                        <td class="orders-status">
                                                                            <div class="badge bg-secondary-soft">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="card">
                                            <div class="card-header">
                                                <h4 class="card-header-title">
                                                    <i class="mdi mdi-crown text-color"></i>API Access Token
                                                </h4>
                                            </div>
                                            <div class="card-body">
                                                <div class="list-group list-group-flush list-group-activity my-n3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="card">
                                            <div class="card-header">
                                                <h4 class="card-header-title">
                                                    <i class="mdi mdi-crown text-color"></i> Postman Collection
                                                </h4>
                                            </div>
                                            <div class="card-body">
                                                <div class="list-group list-group-flush list-group-activity my-n3">
                                                    <div class="list-group-item">
                                                        <div class="row mb-4">
                                                            <div class="col ms-n2">
                                                                <h5 class="mb-1">
                                                                    Click the button below to get postman documentation
                                                                </h5>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <a class="mt-4" href="#">
                                                                    ...
                                                                    {{-- <a href="https://documenter.getpostman.com/view/21209471/2sA3Bj7DCs"
                                                                        target="__blank" name="submit"
                                                                        onclick="this.classList.toggle('button--loading')"
    ...
    <script>
        ...
        function openPostmanCollection(url) {
        ...
        function generateToken() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (apiTokenElement) {
                        apiTokenElement.innerText = token;
                    }
                    Swal.fire({
                        title: "Success!",
        ...
        function copyToClipboard(text) {
            ...
            Swal.fire({
                title: "Success!",
                text: "Api Access Token copied Successfully!",
                icon: "success",
            });
