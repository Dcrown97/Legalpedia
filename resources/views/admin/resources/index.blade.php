                ...
                @if (Auth::user()->role->name == 'Admin')
                    <div class="row align-items-end justify-content-end mt-4 p-3">
                        <form action="{{ route('admin.resources') }}" method="GET" class="me-3 d-flex">
                            ...
                            <a href="{{ url('admin/resources') }}" onclick="this.classList.toggle('button--loading')"
                                            ...
                                            <div class="col-auto">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a href="{{ route('edit.resource', $resource->id) }}"
                                                            class="dropdown-item">
                                ...
                                <div class="stepper-nav justify-content-center">
                                    <form action="{{ route('store.resource') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" id="summernote" rows="5" placeholder="Enter description"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <button type="submit" name="submit"
                                                onclick="this.classList.toggle('button--loading')"
