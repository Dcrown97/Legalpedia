            ...
            <div class="header-body">
                <div class="row align-items-end mb-4">
                    ...
                    @if (Auth::user()->role->name == 'Admin')
                        ...
                        {{-- </div>
                        <form action="{{ route('admin.expojudgepdf', $judgement_summary->id) }}" method="GET"
                            class="d-flex">
                            <button type="submit" onclick="this.classList.toggle('button--loading')"
                                ...
                                <span class="button__text"><i class="mdi mdi-filter"></i> Export PDF</span>
                            </button>
                        </form> --}}
                    @endif
                    @if (Auth::user()->canUseAi())
                        <div class="col-auto">
                            <a href="{{ route('admin.aiJudgementSummary', $judgement_summary->id) }}"
                                class="btn text-white btn-primary" onclick="this.classList.toggle('button--loading')"
                                id="sb">
                    ...
                    @if (Auth::user()->subscribedUser() && Auth::user()->canUseAiCounsel())
                        <div class="col-auto">
                            <a target="_blank"
                                ...
                                <span class="button__text">Go to AI Counsel</span>
                            </a>
                        </div>
                    @endif
                </div>
