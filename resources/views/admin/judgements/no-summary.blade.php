          ...
          <div class="row align-items-center">
            <div class="col">
                <ul class="nav nav-tabs nav-overflow header-tabs" id="myTab" role="tablist">
                    ...
                    @if(Auth::user()->role->name == 'Admin')
                        <li class="nav-item">
                            <a class="nav-link active" href="{{route('judgement.no-summary')}}">
                ...
                <div class="tab-content" id="wizardSteps">
                    <div class="card" data-list='{"valueNames": ["item-name", "item-name1"], "page": 10, "pagination": {"paginationClass": "list-pagination"}}' id="contactsList">
                        <div class="card-header">
                            <h4 class="card-header-title">Cases without summary</h4>
                            <div class="row align-items-end justify-content-end">
                                <form action="{{route('judgement.no-summary')}}" method="GET" class="me-3 d-flex">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end">
                                                                ...
                                                                <form action="/admin/judgements/{{$judgement_summary->id}}" method="POST">
                                                                    {{ csrf_field() }}
                                                                    {{ method_field('DELETE') }}
                                                                    <button type="submit" name="submit" onclick="return deleteLegalFunction();" class="dropdown-item">
