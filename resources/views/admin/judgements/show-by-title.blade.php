...
@section('content')
            ...
            <div class="col-12 col-lg-12 col-xl-12">
                <div class="card">
                    <div class="card-body p-5">
                        <form class="tab-content pb-4" id="wizardSteps"
                            action="{{ route('update.judgement', $judgement_summary->id) }}" method="POST">
                            {{ csrf_field() }}
                            {{ method_field('patch') }}
                            <div class="tab-pane fade show active" id="wizardStepOne" role="tabpanel"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" value="{{ $judgement_summary->title }}"
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    <label class="form-label mb-1">
                                    ...
                                    <input type="text" name="suit_no" value="{{ $judgement_summary->suit_no }}"
                                        class="form-control">
                                </div>
                                <div class="form-group">
                                    <label class="form-label mb-1">
                                    ...
                                    <select name="court_id" id="selected-court" class="form-select"
                                        data-choices='{"searchEnabled": true}'>
                                        <?php $court = App\Models\Court::where('id', $judgement_summary->court_id)->first(); ?>
                                        <option value="{{ $judgement_summary->court_id }}" selected>{{ $court->court }}
                                        </option>
                                ...
                                <div class="row">
                                    <div class="col-12 col-lg-6 col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="lp_citation" id="lp_cite"
                                                value="{{ $judgement_summary->lp_citation }}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-12 col-lg-6 col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="judgement_date" class="form-control"
                                                value="{{ $judgement_summary->judgement_date }}" data-flatpickr>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    @php
                                        $holden = App\Models\Holden::where(
                                            'id',
                                            $judgement_summary ? $judgement_summary->holden_at_id : '',
                                        )->first();
                                    @endphp
                                    <input type="text" name="holden_at" class="form-control"
                                        placeholder="Holden at Abuja" value="{{ $holden ? $holden->holden_at : '' }}">
                                </div>
                                <div class="form-group">
                                    <label class="form-label mb-1">
                                        Party A Type
                                    ...
                                    <select name="party_a_type" class="form-select" data-choices='{"searchEnabled": true}'>
                                        @php
                                            $party_a = App\Models\PartyAType::where(
                                                'id',
                                                $judgement_summary ? $judgement_summary->party_a_type_id : '',
                                            )->first();
                                        @endphp
                                        <option value="{{ $party_a ? $party_a->id : '' }}" selected>
                                            {{ $party_a ? $party_a->party_a_type : 'Select Part A Type' }}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="party_b_type" class="form-select" data-choices='{"searchEnabled": true}'>
                                        @php
                                            $party_b = App\Models\PartyBType::where(
                                                'id',
                                                $judgement_summary ? $judgement_summary->party_b_type_id : '',
                                            )->first();
                                        @endphp
                                        <option value="{{ $party_b ? $party_b->id : '' }}" selected>
                                            {{ $party_b ? $party_b->party_b_type : 'Select Part B Type' }}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="summary_of_facts" id="summernote" rows="5" class="form-control" placeholder="Enter summary">{{ $judgement_summary->summary_of_facts }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label class="form-label mb-1">
                                        Held
                                    </label>
                                    <textarea name="held" rows="5" id="summernote1" class="form-control" placeholder="Enter Held">{{ $judgement_summary->held }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label class="form-label mb-1">
                                        Issues
                                    </label>
                                    <textarea name="issues" rows="5" id="summernote2" class="form-control" placeholder="Enter Issues">{{ $judgement_summary->issues }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label class="form-label mb-1">
                                        Cases Cited
                                    </label>
                                    <textarea name="cases_cited" rows="5" id="summernote3" class="form-control" placeholder="Enter Cases Cited">{{ $judgement_summary->cases_cited }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label class="form-label mb-1">
                                        Statutes Cited
                                    ...
                                    <textarea name="statutes_cited" rows="5" id="summernote4" class="form-control"
                                        placeholder="Enter Statutes Cited">{{ $judgement_summary->statutes_cited }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label class="form-label mb-1">
                                        Other Citations
                                    ...
                                    <textarea name="other_citations" rows="5" id="summernote5" class="form-control"
                                        placeholder="Enter Citations">{{ $judgement_summary->other_citations }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label class="form-label mb-1">
                                        Area of Law
                                    </label>
                                    <textarea name="area_of_law" rows="5" id="summernote6" class="form-control" placeholder="Enter Area of Law">{{ $judgement_summary->area_of_law }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label class="form-label mb-1">
                                        Category
                                    ...
                                    <select name="category" class="form-select" data-choices='{"searchEnabled": true}'>
                                        <option value="{{ $judgement_summary ? $judgement_summary->category : '' }}"
                                            selected>
                                            {{ $judgement_summary ? $judgement_summary->category : 'Select Category' }}
                                        </option>
                            ...
                            <div class="tab-pane fade" id="wizardStepTwo" role="tabpanel"
                                ...
                                @php
                                    $judg_principles = App\Models\JudgementPrinciple::where(
                                        'suit_no',
                                        $judgement_summary ? $judgement_summary->suit_no : '',
                                    )->get();
                                ...
                                @if ($judg_principles)
                                    ...
                                    @foreach ($judg_principles as $judg_principle)
                                        @php
                                            $principle = App\Models\Principle::where(
                                                'id',
                                                $judg_principle ? $judg_principle->principle_id : '',
                                            )->first();
                                        @endphp
                                        <div class="add_more">
                                            <div class="form-group">
                                                ...
                                                @php
                                                    $subject = App\Models\SubjectMatterIndex::where(
                                                        'id',
                                                        $principle ? $principle->subject_matter_index_id : '',
                                                    )->first();
                                                @endphp
                                                <select name="subject[{{ $judg_principle->id }}][]" class="form-select"
                                                    data-choices='{"searchEnabled": true}'>
                                                    <option
                                                        value="{{ $principle ? $principle->subject_matter_index_id : '' }}">
                                                        {{ $subject ? $subject->subject_matter_index : '' }}</option>
                                ...
                                <hr class="my-5">
                                @php
                                    $judg_corams = App\Models\JudgementCoram::where(
                                        'suit_no',
                                        $judgement_summary ? $judgement_summary->suit_no : '',
                                    )->get();
                                    // dd($judg_corams);
                                ...
                                @if ($judg_corams->isNotEmpty())
                                    ...
                                    @foreach ($judg_corams as $coram)
                                        <div class="add_more">
                                            <div class="form-group">
                                                <label class="form-label mb-1">
                                                    {{ $loop->iteration }}. Coram
                                                    {{-- @php
                                                        $coram_no++;
                                                    @endphp --}}
                                                </label>
                                                <input type="hidden" name="corams[{{ $coram->id }}][coram_id]"
                                                    class="form-control" value="{{ $coram->coram_id }}">
                                                <input type="text" name="corams[{{ $coram->id }}][name]"
                                                    class="form-control"
                                                    value="{{ $coram->coram ? $coram->coram->name : '--' }}">
                                            </div>
                                            <div class="form-roup mb-4">
                                                @php
                                                    $main_coram = App\Models\Coram::where(
                                                        'id',
                                                        $coram->coram_id,
                                                    )->first();
                                                @endphp
                                                <div class="justify-content-end">
                                                    <input type="hidden" name="judg_coram_id" id="judg_coram_id"
                                                        value="{{ $coram->id }}">
                                                    <input type="hidden" name="main_coram_id" id="main_coram_id"
                                                        value="{{ $main_coram ? $main_coram->id : '' }}">
                                                    <button type="button" name="remove_coram"
                                                        onclick="removeCoram('{{ $coram->id }}', '{{ $main_coram->id }}')"
                                                        class="text-color custom-button"><i class="mdi mdi-close"></i>
                                                        Remove</button>
                                                </div>
                                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    @endphp
                                    <input type="hidden" name="party_a_name_id"
                                        value="{{ $party_a_name ? $party_a_name->id : null }}">
                                    <textarea name="party_a_names" id="summernote8" rows="5" class="form-control" placeholder="Enter names">{{ $party_a_name ? $party_a_name->party_a_names : '' }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label class="form-label mb-1">
                                        Party B Names
                                    ...
                                    @endphp
                                    <input type="hidden" name="party_b_name_id"
                                        value="{{ $party_b_name ? $party_b_name->id : null }}">
                                    <textarea name="party_b_names" rows="5" id="summernote9" class="form-control" placeholder="Enter names">{{ $party_b_name ? $party_b_name->party_b_names : '' }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label class="form-label mb-1">
                                        Councel
                                    ...
                                    @php
                                        $counsel = App\Models\JudgementCounsel::where(
                                            'suit_no',
                                            $judgement_summary ? $judgement_summary->suit_no : '',
                                        )->first();
                                    @endphp
                                    <input type="hidden" name="counsel_id"
                                        value="{{ $counsel ? $counsel->id : null }}">
                                    <textarea name="counsels" rows="5" id="summernote0" class="form-control" placeholder="Enter Councel">{{ $counsel ? $counsel->counsels : '' }}</textarea>
                                </div>
                                <hr class="my-5">
                                <div class="nav row align-items-center">
                                    <div class="col-auto">
                            ...
                            <div class="tab-pane fade" id="wizardStepThree" role="tabpanel"
                                ...
                                @php
                                    $ratios = App\Models\SummaryRatio::where(
                                        'suit_no',
                                        $judgement_summary ? $judgement_summary->suit_no : '',
                                    )->get();
                                ...
                                @if ($ratios)
                                    @php
                                        $ratio_no = 1;
                                        $id_start = 61; // Starting ID for Summernote textareas
                                    @endphp
                                    @foreach ($ratios as $ratio)
                                        <div class="add_more">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="ratio[{{ $ratio->id }}][]"
                                                    class="form-control" value="{{ $ratio->heading }}">
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label mb-1">
                                                    Ratio Body
                            ...
                            <div class="tab-pane fade" id="wizardStepFour" role="tabpanel"
                                ...
                                <div class="add_more">
                                    <div class="form-group">
                                        ...
                                        @php
                                            $judgement = App\Models\Judgement::where(
                                                'suit_no',
                                                $judgement_summary ? $judgement_summary->suit_no : '',
                                            )->first();
                                        @endphp
                                        <input type="hidden" name="judgement_id"
                                            value="{{ $judgement ? $judgement->id : null }}">
                                        <textarea name="judgement" rows="5" id="summernote11" class="form-control" placeholder="">{{ $judgement ? $judgement->judgement : '' }}</textarea>
                                    </div>
                                </div>
                                <hr class="my-5">
                                <div class="nav row align-items-center">
    ...
    <script>
        ...
        function removeCoram(judg_coram_id, main_coram_id) {
            ...
            //  main_coram_id = document.getElementById(main_coram_id).value;
            $.ajax({
                type: "POST",
                url: '/admin/judgements/remove/coram',
                data: {
                    "_token": "{{ csrf_token() }}",
                    judg_coram_id: judg_coram_id,
                    main_coram_id: main_coram_id
                },
        ...
        function addFields() {
            update_coram_no++;
            console.log(update_coram_no, 'first')
            coram_id++;
            var objTo = document.getElementById('add_field');
            var divcreate = document.createElement("div");
            divcreate.classList.add('add_more');
            divcreate.innerHTML = '<div class="form-group"><label class="form-label mb-1">' + update_coram_no +
                '. Coram</label><input type="text" name="new_corams[' + coram_id + '][name]" class="form-control"></div>' +
                '<div class="form-group mb-4"><div class="justify-content-end"><button type="button" class="text-color custom-button" onclick="removeCoramField(this)">' +
                '<i class="mdi mdi-close"></i> Remove</button></div></div>';
            objTo.appendChild(divcreate);
        }
