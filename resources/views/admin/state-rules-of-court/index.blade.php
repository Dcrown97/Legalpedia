                ...
                @if (Auth::user()->role->name == 'Admin')
                    <div class="row align-items-end justify-content-end mt-4 p-3">
                        <form action="{{ route('admin.state-rules-of-court') }}" method="GET" class="me-3 d-flex">
                            <select name="name" class="form-select mr-8" data-choices='{"searchEnabled": true}'>
                                @foreach ($states as $state)
                                    <option value="{{ $state->name }}"
                                        {{ $state->name == $selected_name['name'] ? 'selected' : '' }}>{{ $state->name }}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <a href="{{ url('admin/state-rules-of-court') }}"
                            ...
                            <form action="{{ route('admin.state-rules-of-court') }}" method="GET" class="me-3 d-flex">
                                ...
                                <select name="name" class="form-select mr-8" data-choices='{"searchEnabled": true}'>
                                    @foreach ($all_states as $state)
                                        ...
                                        @endphp
                                        <option value="{{ $main_state->name }}"
                                            {{ $main_state->name == $selected_name['name'] ? 'selected' : '' }}>
                                            {{ $main_state->name }}</option>
                                    @endforeach
                                </select>
                                <button type="submit" name="fetch_rule" onclick="this.classList.toggle('button--loading')"
                                    class="ml-3 mr-3 btn button_load text-white btn-sm btn-primary p-2">
                                                    ...
                                                    <div class="col">
                                                        <h4 class="mb-1 item-name">
                                                            <i class="fe fe-file mr-1"></i><a
                                                                href="{{ route('show.state-rule', $order->id) }}">{{ $order->title }}</a>
                                                        </h4>
                                                    </div>
                                                    @if (Auth::user()->role->name == 'Admin')
                                                        <div class="col-auto">
                                            ...
                                            <li class="list-group-item">
                                                <div class="row align-items-center">
                                                    <div class="col">
                                                        <h4 class="mb-1 item-name">
                                                            <i class="fe fe-file mr-1"></i><a
                                                                href="{{ route('show.state-rule', $part->id) }}">{{ $part->title }}</a>
                                                        </h4>
                                                    </div>
                                                    @if (Auth::user()->role->name == 'Admin')
                                                        <div class="col-auto">
                                            ...
                                            <li class="list-group-item">
                                                <div class="row align-items-center">
                                                    <div class="col">
                                                        <h4 class="mb-1 item-name">
                                                            <i class="fe fe-file mr-1"></i><a
                                                                href="{{ route('show.state-rule', $schedule->id) }}">{{ $schedule->title }}</a>
                                                        </h4>
                                                    </div>
                                                    @if (Auth::user()->role->name == 'Admin')
                                                        <div class="col-auto">
                                            ...
                                            <li class="list-group-item">
                                                <div class="row align-items-center">
                                                    <div class="col">
                                                        <h4 class="mb-1 item-name">
                                                            <i class="fe fe-file mr-1"></i><a
                                                                href="{{ route('show.state-rule', $form->id) }}">{{ $form->title }}</a>
                                                        </h4>
                                                    </div>
                                                    @if (Auth::user()->role->name == 'Admin')
                                                        <div class="col-auto">
                                            ...
                                            <li class="list-group-item">
                                                <div class="row align-items-center">
                                                    <div class="col">
                                                        <h4 class="mb-1 item-name">
                                                            <i class="fe fe-file mr-1"></i><a
                                                                href="{{ route('show.state-rule', $probate_form->id) }}">{{ $probate_form->title }}</a>
                                                        </h4>
                                                    </div>
                                                    @if (Auth::user()->role->name == 'Admin')
                                                        <div class="col-auto">
                                            ...
                                            <li class="list-group-item">
                                                <div class="row align-items-center">
                                                    <div class="col">
                                                        <h4 class="mb-1 item-name">
                                                            <i class="fe fe-file mr-1"></i><a
                                                                href="{{ route('show.state-rule', $civil_form->id) }}">{{ $civil_form->title }}</a>
                                                        </h4>
                                                    </div>
                                                    @if (Auth::user()->role->name == 'Admin')
                                                        <div class="col-auto">
                                            ...
                                            <li class="list-group-item">
                                                <div class="row align-items-center">
                                                    <div class="col">
                                                        <h4 class="mb-1 item-name">
                                                            <i class="fe fe-file mr-1"></i><a
                                                                href="{{ route('show.state-rule', $appendix->id) }}">{{ $appendix->title }}</a>
                                                        </h4>
                                                    </div>
                                                    @if (Auth::user()->role->name == 'Admin')
                                                        <div class="col-auto">
                                            ...
                                            <div class="col-12 col-lg-6 col-xl-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="name" class="form-select"
                                                        ...
                                                        @foreach ($states as $state)
                                                            <option value="{{ Str::upper($state->name) }}">
                                                                {{ Str::upper($state->name) }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
