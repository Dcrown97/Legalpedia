              ...
              <div class="card-header">
                ...
                <form class="">
                  <select class="form-select form-select-sm form-control-flush" data-choices='{"searchEnabled": true}'>
                    ...
                    <option value="asc">ABUJA</option>
                    <option value="desc">ADAMAWA</option>
                    <option value="desc">AKWA-IBOM</option>
                    <option value="desc">ANAMBRA</option>
                    <option value="desc">BAUCHI</option>
                  </select>
                </form>
