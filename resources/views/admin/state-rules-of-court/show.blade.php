...
@section('content')
            ...
            <div class="header-body">
                <div class="row align-items-end mb-4">
                    ...
                    @if(Auth::user()->role->name == 'Admin')
                        <div class="col-auto">
                            @if($order)
                                <a href="{{route('edit.state-rule', $order->id)}}" class="btn text-white btn-primary">
                                    <i class="mdi mdi-pencil"></i> Edit State Rule
                                </a>
                                @elseif($schedule)
                                <a href="{{route('edit.state-rule', $schedule->id)}}" class="btn text-white btn-primary">
                                    <i class="mdi mdi-pencil"></i> Edit State Rule
                                </a>
                                @elseif($part)
                                <a href="{{route('edit.state-rule', $part->id)}}" class="btn text-white btn-primary">
                                    <i class="mdi mdi-pencil"></i> Edit State Rule
                                </a>
                                @elseif($form)
                                <a href="{{route('edit.state-rule', $form->id)}}" class="btn text-white btn-primary">
                                    <i class="mdi mdi-pencil"></i> Edit State Rule
                                </a>
                                @elseif($probate_form)
                                <a href="{{route('edit.state-rule', $probate_form->id)}}" class="btn text-white btn-primary">
                                    <i class="mdi mdi-pencil"></i> Edit State Rule
                                </a>
                                @elseif($civil_form)
                                <a href="{{route('edit.state-rule', $civil_form->id)}}" class="btn text-white btn-primary">
                                    <i class="mdi mdi-pencil"></i> Edit State Rule
                                </a>
                                @elseif($appendix)
                                <a href="{{route('edit.state-rule', $appendix->id)}}" class="btn text-white btn-primary">
                                    <i class="mdi mdi-pencil"></i> Edit State Rule
                                </a>
                            @endif
                        </div>
    ...
    <script>
        ...
        function fetchAnote() {
            $.ajax({
                type: 'GET',
                url: "/admin/state-rules-of-court/fetch-annotations/" + ruleId,
                success: function (response) {
                    console.log(response);
