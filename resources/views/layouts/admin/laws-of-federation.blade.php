...
<head>
    ...
    {{-- <script src="https://cdn.tiny.cloud/1/krgqhy8swtxuko7fbszjqzxzx68s0jzo430qxp9ormf1gm7g/tinymce/7/tinymce.min.js"
...
<body>
    ...
    @include('elements.sidebar.laws-of-federation')
    @include('elements.off-canvas.laws-of-federation')
    ...
    <script>
        ...
        var section_noss = 1;
        var section_nos = 0;
        var newPartSummernote = 101;
        var newPartSecSummernote = 151;
        var sched_no = 1;
        var addPartSummernote = 200;
        var addPartSecSummernote = 251;
        var newSchedsSummernote = 400;
