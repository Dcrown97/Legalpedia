                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="tab-content" id="wizardSteps">
                                <div class="tab-pane fade show active" id="login" style="height: 100vh" role="tabpanel"
                                    ...
                                    <form method="POST" action="{{ route('register') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input id="surname" type="text"
                                                ...
                                                placeholder="Last Name" name="surname" value="{{ old('surname') }}"
                                        ...
                                        <div class="form-group mb-30">
                                            <label for="password">Password</label>
                                            <i class="mdi mdi-eye-off-outline eye-icon" id="togglePasswords"></i>
                                        ...
                                        <div class="form-group">
                                            <label for="area_of_practice">Area of Practice <span
                                                    class="text-color">*<span></label>
                                            <input type="text"
                                                class="form-control @error('area_of_practice') is-invalid @enderror"
                                                placeholder="Area of Practice" name="area_of_practice" required
                                                value="{{ old('area_of_practice') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                class="form-control @error('nba_branch') is-invalid @enderror"
                                                placeholder="NBA Branch" name="nba_branch" required
                                                value="{{ old('nba_branch') }}">
                                            @error('nba_branch')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group mb-30">
                                            ...
                                            <input id="phone" type="text"
                                                ...
                                                placeholder="23481000xxxxx" name="phone" required
                                                value="{{ old('phone') }}">
                                            @error('phone')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
