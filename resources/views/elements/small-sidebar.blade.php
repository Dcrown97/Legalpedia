    ...
    <div class="container-fluid">
        ...
        <div class="navbar-user d-md-none">
            ...
            <div class="dropdown">
                ...
                <!-- Toggle -->
                <a href="#" id="sidebarSmallIcon" class="dropdown-toggle" role="button" data-bs-toggle="dropdown"
        ...
        <div class="collapse navbar-collapse" id="sidebarSmallCollapse">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropend">
                    <a class="nav-link dropdown-toggle " id="sidebarSmallPages" href="#" data-bs-toggle="dropdown"
                ...
                <li class="nav-item dropend">
                    <a class="nav-link dropdown-toggle" id="sidebarSmallAuth" href="#"
                        data-bs-toggle="dropdown" data-bs-auto-close="outside" role="button" aria-haspopup="true"
                        aria-expanded="false">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="docs/changelog.html" data-bs-toggle="tooltip"
                        ...
                        <i class="fe fe-git-branch"></i> <span class="d-md-none">Changelog</span> <span
                            class="badge bg-primary ms-auto d-md-none">v2.1.0</span>
                    </a>
                </li>
            </ul>
