            ...
            <div class="list-group list-group-flush list-group-focus list">
                ...
                <ul class="navbar-nav">
                    ...
                    @if (Auth::user()->role->name == 'Admin')
                        <li class="nav-item" style="background: #f5f5f5">
                            <a class="nav-link active" href="#cat" data-bs-toggle="collapse" role="button"
                    ...
                    @else
                        <li class="nav-item" style="background: #f5f5f5">
                            <a class="nav-link active" href="{{ url('admin/rules-of-court') }}">
                                <i class="fe fe-bell"></i> Rules of Court
                            </a>
                        </li>
                    @endif
                ...
                <div class="mt-auto">
                    <div class="navbar-user d-none d-md-flex" id="sidebarUser">
                        <a class="navbar-user-link-0" data-bs-toggle="offcanvas" href="#sidebarOffcanvasActivity"
                        ...
                        <div class="dropup">
                            ...
                            <div class="dropdown-menu" aria-labelledby="sidebarIconCopy">
                                ...
                                <a class="dropdown-item" href="{{ route('logout') }}"
                                    ...
                                    <span class="mr-2" aria-hidden="true"><i
                                            class="mdi mdi-logout-variant"></i></span> Sign out
                                </a>
