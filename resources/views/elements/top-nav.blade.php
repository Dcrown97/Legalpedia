<nav class="navbar navbar-expand-lg " id="topnav">
    <div class="container">
        ...
        <a class="navbar-user-link-0" data-bs-toggle="offcanvas" href="#sidebarOffcanvasSearch"
        ...
        <a class="navbar-brand me-auto" href="index.html">
            <img src="{{ asset('assets/images/legalpedia_logo.png') }}" alt="..." class="navbar-brand-img">
        </a>
                            ...
                            <a class="list-group-item text-reset" href="#!">
                                <div class="row">
                                    ...
                                    <div class="col ms-n2">
                                        ...
                                        <!-- Content -->
                                        <div class="small">
                                            <strong>Welcome onboard!</strong> {{ Auth::user()->name }}, Legalpedia has
                                            just the right resources for you to get started
                                        </div>
            ...
            <ul class="navbar-nav me-lg-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="topnavPages">
                        <li class="dropend">
                            <a class="dropdown-item dropdown-toggle " href="#" id="topnavAccount"
                        ...
                        <li class="dropend">
                            <a class="dropdown-item dropdown-toggle " href="#" id="topnavProfile"
                                role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Profile
                            </a>
                        ...
                        <li class="dropend">
                            <a class="dropdown-item dropdown-toggle " href="#" id="topnavProject"
                                role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Project
                            </a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="topnavAuth">
                        ...
                        <li class="dropend">
                            <a class="dropdown-item dropdown-toggle" href="#" id="topnavPassword"
                                role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Password reset
                            </a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="topnavDocumentation">
                        <li class="dropend">
                            <a class="dropdown-item dropdown-toggle " href="#" id="topnavBasics"
                                role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Basics
                            </a>
