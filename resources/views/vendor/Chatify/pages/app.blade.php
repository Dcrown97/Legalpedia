    ...
    <div class="messenger">
            ...
            <div class="m-header">
                <nav>
                    ...
                    <nav class="m-header-right">
                        <a href="#" style="display: none"><i class="fas fa-cog settings-btn"></i></a>
            ...
            <div class="@if($type == 'group') show @endif messenger-tab groups-tab app-scroll" data-view="groups">
                {{-- items --}}
                    <p style="text-align: center;color:grey;margin-top:30px">
                        <a target="_blank" style="color:{{$messengerColor}};" href="!#">No member found</a>
                    </p>
                    {{-- @if(count($approved_members) > 0)
                        @foreach($approved_members)
                            <table class="messenger-list-item" data-contact="5">
                                <tbody>
                                    <tr data-action="0">
                                        <td style="position: relative">
                                            <span class="activeStatus"></span>
                                            @php $user = App\Models\User::where('id', $approved_member->user_id)->first(); @endphp
                                            @if($user->photo)
                                                <div class="avatar av-m" style="background-image: url('{{$user->photo}}');"></div>
                                                @else
                                                <div class="initials">
        ...
        <div class="messenger-messagingView">
            ...
            <div class="m-header m-header-messaging">
                <nav>
                    ...
                    <div style="display: inline-flex;">
                        ...
                        <a href="#" class="user-name">New Chat</a>
                    </div>
                    {{-- header buttons --}}
                    <nav class="m-header-right">
            ...
            <div class="m-body messages-container app-scroll">
                <div class="messages">
                    <p class="message-hint center-el"><span>Please select a member to start messaging</span></p>
                </div>
                {{-- Typing indicator --}}
