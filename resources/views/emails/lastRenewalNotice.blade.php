                    ...
                    <td class="content-cell">
                      <div class="f-fallback">
                        ...
                        <table class="discount" align="center" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                          <tr>
                            <td>
                                <p class="f-fallback discount_body"> Your Legalpedia package {{$package_name}} expires in 24hrs. Renew you subscription now to retain access to Legalpedia resources.</p>
