                    ...
                    <td class="content-cell">
                      <div class="f-fallback">
                        ...
                        <table class="discount" align="center" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                          ...
                          <tr>
                            <td>
                              <p class="f-fallback discount_body">You now have access to Legalpedia resources. Below are your License credentials to sign in</p>
                              <p class="f-fallback discount_body">Licensed Email: {{$email}}</p>
                              <p class="f-fallback discount_body">Licensed Code: {{$code}}</p>
                              <p class="f-fallback discount_body">This License is valid for {{$validity}} days</p>
                            </td>
                          </tr>
                          <tr>
                              <td align="center">
