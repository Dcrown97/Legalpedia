                    ...
                    <td class="content-cell">
                      <div class="f-fallback">
                        ...
                        <table class="discount" align="center" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                          ...
                          <tr>
                            <td>
                                <p class="f-fallback discount_body">You have a new report from {{$user}}</p>
                                <p class="f-fallback discount_body">Name: {{$user}}</p>
                                <p class="f-fallback discount_body">Email: {{$email}}</p>
                                <p class="f-fallback discount_body">Report Type: {{$report_type}}</p>
                                @if(!$report_message == '')
                                    <p class="f-fallback discount_body">Report Message: {{$report_message}}</p>
                                @else
                                    <p class="f-fallback discount_body">Report Message: {{$other_message}}</p>
                                @endif
                            </td>
                          </tr>
                          <tr>
