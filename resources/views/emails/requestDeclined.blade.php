                    ...
                    <td class="content-cell">
                      <div class="f-fallback">
                        ...
                        <table class="discount" align="center" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                          <tr>
                            <td>
                                <p class="f-fallback discount_body">Sorry, your request to join this team was declined, please join another team</p>
                            </td>
                          </tr>
                          <tr>
                              <td align="center">
                                <a href="{{url('admin/teams')}}" class="btn btn-primary text-white" data-bs-toggle="modal" data-bs-target="#admin_note" id="kt_toolbar_primary_button" class="btn btn-primary lift">
                                    <i class="fe fe-plus"></i> View Teams
                                </a>
                              </td>
                          </tr>
                        </table>
