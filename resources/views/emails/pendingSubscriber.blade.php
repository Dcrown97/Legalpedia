                    ...
                    <td class="content-cell">
                      <div class="f-fallback">
                        ...
                        <table class="discount" align="center" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                          {{-- <tr>
                            <td align="center">
                              <p class="f-fallback discount_heading"><strong>{{$subject}}</strong></p>
                            </td>
                          </tr> --}}
                          <tr>
                            <td>
                                <p class="f-fallback discount_body">Your payment is still currently pending and has not been confirmed, please contact support at <a href="mailto:support@legalpediaresources.com">support@legalpediaresources.com</a></p>
                                <p class="f-fallback discount_body">Package: {{$package}}</p>
                                <p class="f-fallback discount_body">Amount: ₦{{number_format($amount, 2)}}</p>
                                <p class="f-fallback discount_body">Payment Reference ID: {{$reference}}</p>
                                <p class="f-allback discount_body">You can now sign in and get access to Legalpedia resources</p>
                            </td>
                          </tr>
                          <tr>
                              <td align="center">
