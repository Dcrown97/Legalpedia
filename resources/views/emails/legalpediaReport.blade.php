                    ...
                    <td class="content-cell">
                      <div class="f-fallback">
                        ...
                        <table class="discount" align="center" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                          <tr>
                            <td>
                                <p class="f-fallback discount_body">We have received your report and our support team will be in touch shortly via email</p>
                                <p class="f-fallback discount_body">In the meantime, see recent cases lined up on your dashboard</p>
                            </td>
                          </tr>
                          <tr>
                              <td align="center">
                                <a href="{{route('login')}}" class="btn btn-primary text-white" data-bs-toggle="modal" data-bs-target="#admin_note" id="kt_toolbar_primary_button" class="btn btn-primary lift">
                                    <i class="fe fe-plus"></i> View Cases
                                </a>
                              </td>
                          </tr>
                        </table>
