                                                ...
                                                <tr>
                                                    <td>
                                                        @if ($billing_type === 'paid')
                                                            <p class="f-fallback discount_body"> This user
                                                                {{ $user }} {{ $user_surname }} has just
                                                                subscribed to {{ $package_name }}</p>
                                                            <p class="f-fallback discount_body"> The payment method is
                                                                Bank Transfer, please update this user's transaction
                                                                status upon receival of valid payment receipt to
                                                                activate user's package</p>
                                                            <p class="f-fallback discount_body"> The transaction details
                                                                are below</p>
                                                            <p class="f-fallback discount_body"> Payment Reference ID:
                                                                {{ $reference }}</p>
                                                            <p class="f-fallback discount_body"> Subscribed Package:
                                                                {{ $package_name }}</p>
                                                            <p class="f-fallback discount_body"> Amount to be paid:
                                                                ₦{{ number_format($package_price) }}</p>
                                                        ...
                                                        @else
                                                            <p class="f-fallback discount_body"> This user
                                                                {{ $user }} {{ $user_surname }} has just
                                                                activated a <strong>trial</strong> subscription for
                                                                {{ $package_name }}</p>
                                                            <p class="f-fallback discount_body"> No payment is required
                                                                for trial activation. The user will have full access for
                                                                the trial period.</p>
                                                            <p class="f-fallback discount_body"> Please ensure the trial
                                                                start date is recorded and access will be disabled
                                                                automatically after the trial ends unless upgraded.</p>
                                                            <p class="f-fallback discount_body"> Trial Activation Date:
                                                                {{ $date }}</p>
                                                            <p class="f-fallback discount_body"> Name:
                                                                {{ $name }}</p>
                                                            <p class="f-fallback discount_body"> Email:
